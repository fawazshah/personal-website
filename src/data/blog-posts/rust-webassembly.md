...
In the last few months, I've been playing around with Rust code in the context of a web application. Rust is mainly compiled to some version of `x86_64`, depending on whether you are running on Windows/MacOS/Linux, but one compilation target that has gained popularity is `wasm` or WebAssembly.

<p align="center">
  <img src="/public/assets/webassembly.jpg" width="400">
</p>
